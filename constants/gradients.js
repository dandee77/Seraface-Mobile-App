...
export const Gradients = {
  ...
  // Custom combinations
  purpleToPink: [Colors.primary800, Colors.primary600, Colors.accent300], // Brand gradient
  lightPurple: [Colors.primary500, Colors.primary400, Colors.primary200], // Subtle purple
